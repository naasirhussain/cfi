...
function addWithReturn(a,b){
    return a + b;     // this returns the result so we can use it later
}
let result = addWithReturn(3, 2);  // stores the result of 3+2, which is 5
console.log("Fisrt Reslt", result);  // out put: First Result : 5

// Now we can use this result in further calculations
let duobleResult = result * 2;  // doubleResult; 
