...
// college = String(true); // true
// college = String(false);  // false
// college = String(null); // null
// console.log(college);


// 3. converting to booleans (true/ false)
let university;
university = Boolean(23); // true boolean
university = Boolean("32"); // true boolean
