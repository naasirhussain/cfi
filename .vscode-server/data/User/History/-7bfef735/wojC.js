...
console.log(myAmazonUser);   // prints myAmazonUser and add id : AMZ00234.

delete myAmazonUser.cart;
console.log(myAmazonUser);   // prints myAmazonUser and delete cart.




// when to use objects
// --> when you need to group related data and funstions logically
// --> when each element has a name or idenfier (like, "name" or "age")
